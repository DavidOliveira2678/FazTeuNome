...
>
              ...
              <div className="texto">
                ...
                <span className="duracao"><Icons.Play /> 20 min</span>
              </div>
            ...
            <div className="card-licao locked">
              ...
              <div className="texto">
                ...
                <span className="duracao"><Icons.Play /> 25 min</span>
              </div>
              <div className="status-icons">
                <span className="chevron">❯</span>
                <Icons.Lock />
            ...
            <div className="card-licao locked">
              ...
              <div className="texto">
                ...
                <span className="duracao"><Icons.Play /> 30 min</span>
              </div>
              <div className="status-icons">
                <span className="chevron">❯</span>
                <Icons.Lock />
          ...
          <aside className="detalhes-card">
            ...
            <div className="recursos">
              ...
              <div className="recurso-item"><Icons.Flame /> Vídeo explicativo</div>
